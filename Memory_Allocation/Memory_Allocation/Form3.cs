    ...
    public partial class Form3 : Form
    {
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            for (int a = 0; a < dataGridView1.Rows.Count; a++)
            {
                ...
                if (dataGridView1.Rows[a].Cells[2].Value != null && dataGridView1.Rows[a].Cells[2].Value.ToString().Trim() != "")

                {

                    string DataToValidate = dataGridView1.Rows[a].Cells[2].Value.ToString();
...

                    {
                        ...
                        dataGridView1.Rows[a].Cells[2].ErrorText = "You Can Only Enter Number here ";
